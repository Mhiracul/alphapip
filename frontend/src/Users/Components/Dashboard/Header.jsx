  ...
  return (
    <div
      className={`px-6 w-full sticky top-0 z-[99999] ${
        scrolling
          ? "bg-gradient"
          : "bg-[#FDFEFE] bg-opacity-20 backdrop-blur-lg"
      }`}
    >
      <i className="mr-1 fa fa-clock"></i>

      <main
        className={`ease-soft-in-out   h-full  rounded-xl transition-all duration-200  sticky top-[1%]  bg-[#FDFEFE]  
        bg-opacity-20 backdrop-blur-lg  shadow-md shadow-[#ccc9c9] z-[110] `}
      >
        <nav
                ...
                >
                  ...
                  >
                    <div className="w-4.5 overflow-hidden">
                      <i
                        className={`ease-soft mb-0.75 relative block h-0.5 rounded-sm bg-slate-500 transition-all ${
